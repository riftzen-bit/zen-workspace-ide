...
- Integrated floating `VibePlayer` seamlessly streams *Lofi* or *Rain* vibes.
...
- **Interacting with AI:**
  Enter your Gemini API key via the `Assistant` tab to unlock the chat interface. Try saying *"Play some deep focus coding music"*.
- **Managing Files:**
